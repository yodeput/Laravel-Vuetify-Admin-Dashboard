...
export default {
    setup() {
        const deposit = [
            {
                img: './assets/images/logos/gumroad.png',
                title: 'Gumroad Account',
                subtitle: 'Sell UI Kit',
                amount: '+$4,650',
            },
            {
                img: './assets/images/logos/master.png',
                title: 'Mastercard',
                subtitle: 'Wallet deposit',
                amount: '+$92,705',
            },
            {
                img: './assets/images/logos/stripe-account.png',
                title: 'Stripe Account',
                subtitle: 'iOS Application',
                amount: '+$957',
            },
            {
                img: './assets/images/logos/american-bank.png',
                title: 'American Bank',
                subtitle: 'Bank Transfer',
                amount: '+$6,837',
            },
            {
                img: './assets/images/logos/bank-account.png',
                title: 'Bank Account',
                subtitle: 'Wallet deposit',
                amount: '+$446',
            },
        ...
        const withdraw = [
            ...
            {
                img: './assets/images/logos/slack.png',
                title: 'Upgrade Slack Plan',
                subtitle: 'Debit card deposit',
                amount: '-$450',
            },
            {
                img: './assets/images/logos/digital-ocean-logo.png',
                title: 'Digital Ocean',
                subtitle: 'Cloud Hosting',
                amount: '-$540',
            },
            {
                img: './assets/images/logos/amazon-web-services-logo.png',
                title: 'Bank Account',
